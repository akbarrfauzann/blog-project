      ...
      <Card>
        <Card.Grid>
          ...
          <div className="card-post">
            <img src="./art1.jpg" alt="" style={{ objectFit: "cover", marginTop: "10px", width: "100%", height: "auto", maxHeight: "300px" }} />
            <h3>Hope die last</h3>
        ...
        <Card.Grid>
          ...
          <div className="card-post">
            <img src="./street.jpg" alt="" style={{ objectFit: "cover", marginTop: "10px", width: "100%", height: "auto", maxHeight: "300px" }} />
            <h3>Hope die last</h3>
        ...
        <Card.Grid>
          ...
          <div className="card-post">
            <img src="./sculptures.jpg" alt="" style={{ objectFit: "cover", marginTop: "10px", width: "100%", height: "auto", maxHeight: "300px" }} />
            <h3>Hope die last</h3>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed aliquam voluptate dignissimos laudantium dolorem ducimus rem nihil ipsum magni fugiat?</p>
          </div>
          <div className="card-author">
